...
const About: React.FC = () => {
  const keywords = [
    { title: '꼼꼼함', desc: '모든 데이터의 이면을 파고드는 철저함', icon: '🎯' },
    { title: '창의성', desc: '기존의 틀을 깨는 혁신적 솔루션 도출', icon: '💡' },
    { title: '미래 예측성', desc: '트렌드를 분석하여 앞서 나가는 인사이트', icon: '🌐' }
  ];
  ...
  return (
    <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-16 items-center">
      ...
      <div>
        <h2 className="text-4xl font-black mb-8 border-l-4 border-blue-500 pl-6 uppercase italic">About Me</h2>
        ...
        <div className="grid gap-6">
          {keywords.map((item, idx) => (
            <div key={idx} className="glass-panel p-6 rounded-xl flex items-start gap-6 hover:translate-x-2 transition-transform duration-300">
